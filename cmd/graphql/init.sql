do
    ...
    begin        
        ...
        grant select("id", "content_index", "network", "protocol", "hash", "counter", "nonce", "internal", "status", "timestamp", "level", "kind", "initiator", "source", "fee", "gas_limit", "storage_limit", "amount", "destination", "delegate", "entrypoint", "source_alias", "destination_alias", "parameters", "deffated_storage", "delegate_alias", "consumed_gas", "storage_size", "paid_storage_size_diff", "allocated_destination_contract", "errors", "burned", "allocated_destination_contract_burned") on operations to graphql;
