...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "contract_metadata.Event": {
            ...
            "properties": {
                ...
                "implementations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/contract_metadata.EventImplementation"
                    }
                },
                "name": {
                    "type": "string"
        ...
        "contract_metadata.EventImplementation": {
            "type": "object",
            "properties": {
                "michelsonExtendedStorageEvent": {
                    "$ref": "#/definitions/contract_metadata.MichelsonExtendedStorageEvent"
                },
                "michelsonInitialStorageEvent": {
                    "$ref": "#/definitions/contract_metadata.MichelsonInitialStorageEvent"
                },
                "michelsonParameterEvent": {
                    "$ref": "#/definitions/contract_metadata.MichelsonParameterEvent"
                }
            }
        },
        "contract_metadata.License": {
            "type": "object",
            "properties": {
                "details": {
                    "type": "string"
        ...
        "contract_metadata.MichelsonExtendedStorageEvent": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "array",
        ...
        "contract_metadata.MichelsonInitialStorageEvent": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "array",
        ...
        "contract_metadata.MichelsonParameterEvent": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "array",
        ...
        "contract_metadata.ViewImplementation": {
            "type": "object",
            "properties": {
                "michelsonStorageView": {
                    "$ref": "#/definitions/contract_metadata.Sections"
                }
            }
        },
        "gin.H": {
        ...
        "handlers.TZIPResponse": {
            ...
            "properties": {
                ...
                "events": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/contract_metadata.Event"
                    }
                },
                "extras": {
                    "type": "object",
                ...
                "license": {
                    "$ref": "#/definitions/contract_metadata.License"
                },
                "name": {
                    "type": "string"
                },
                ...
                "views": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/contract_metadata.View"
                    }
                }
            }
        },
