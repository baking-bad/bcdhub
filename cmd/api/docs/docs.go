...
// 2020-05-18 19:36:53.560258302 +0300 MSK m=+15.261300014
...
var doc = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/database.SubRating"
                            }
                        }
                    },
                    "400": {
        ...
        "/contract/{network}/{address}/rich_storage": {
            "get": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/elastic.SameContractsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/elastic.SimilarContract"
                            }
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/elastic.ProjectStats"
                            }
                        }
                    },
                    "500": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/database.Alias"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "description": "One of index name (contract, operation)",
                        "name": "index",
                        "in": "query",
                        "required": true
                    },
                    {
                        ...
                        "type": "string",
                        "description": "One of period (year, month, week, day)",
                        "name": "period",
                        "in": "query",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "elastic.ProjectStats": {
            ...
            "properties": {
                ...
                "last": {
                    "type": "object",
                    "$ref": "#/definitions/elastic.LightContract"
                },
                "last_action": {
                    "type": "string"
                },
        ...
        "elastic.SimilarContract": {
            ...
            "properties": {
                ...
                "last_action": {
                    "type": "object",
                    "$ref": "#/definitions/models.BCDTime"
                },
                "level": {
                    "type": "integer"
                },
        ...
        "handlers.Operation": {
            ...
            "properties": {
                ...
                "balance_updates": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.BalanceUpdate"
                    }
                },
                "burned": {
                    "type": "integer"
