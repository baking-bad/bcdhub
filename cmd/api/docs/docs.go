...
// 2020-10-28 14:39:19.629449971 +0300 MSK m=+38.641796004
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/elastic.TransfersResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "tzip.EventImplementation": {
            ...
            "properties": {
                "michelson-parameter-view": {
                    "type": "object",
                    "$ref": "#/definitions/tzip.MichelsonParameterView"
                }
            }
        },
        "tzip.License": {
        ...
        "tzip.TokenMetadataType": {
            ...
            "properties": {
                "static": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/tzip.TokenMetadata"
                    }
                }
            }
        }
