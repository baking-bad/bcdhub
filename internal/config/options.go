...
// WithStorage -
func WithStorage(cctx context.Context, cfg StorageConfig, appName string, maxPageSize int64, timeout time.Duration) ContextOption {
	return func(ctx *Context) {
