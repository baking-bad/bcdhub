...
var networkNames = map[Network]string{
	...
	TezosxPreviewnet:   "tezosx_previewnet",
	EtherlinkMainnet:   "etherlink_mainnet",
	EtherlinkShadownet: "etherlink_shadownet",
}
...
var namesToNetwork = map[string]Network{
	...
	"tallinnnet":          Tallinnnet,
	"ushuaianet":          Ushuaianet,
	"tezosx_previewnet":   TezosxPreviewnet,
	"etherlink_mainnet":   EtherlinkMainnet,
	"etherlink_shadownet": EtherlinkShadownet,
}
