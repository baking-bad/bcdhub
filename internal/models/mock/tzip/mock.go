...
func (m *MockRepository) GetWithEvents() ([]tzipModel.TZIP, error) {
	m.ctrl.T.Helper()
...
// GetLastIDWithEvents mocks base method
func (m *MockRepository) GetLastIDWithEvents() (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLastIDWithEvents")
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLastIDWithEvents indicates an expected call of GetLastIDWithEvents
func (mr *MockRepositoryMockRecorder) GetLastIDWithEvents() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLastIDWithEvents", reflect.TypeOf((*MockRepository)(nil).GetLastIDWithEvents))
}

// GetBySlug mocks base method
func (m *MockRepository) GetBySlug(slug string) (*tzipModel.TZIP, error) {
	m.ctrl.T.Helper()
