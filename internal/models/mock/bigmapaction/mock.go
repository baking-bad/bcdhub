...
func (mr *MockRepositoryMockRecorder) Get(ctx, ptr, limit, offset any) *MockRepositoryGetCall {
...
func (c *MockRepositoryGetCall) Return(arg0 []bigmapaction.BigMapAction, arg1 error) *MockRepositoryGetCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRepositoryGetCall) Do(f func(context.Context, int64, int64, int64) ([]bigmapaction.BigMapAction, error)) *MockRepositoryGetCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRepositoryGetCall) DoAndReturn(f func(context.Context, int64, int64, int64) ([]bigmapaction.BigMapAction, error)) *MockRepositoryGetCall {
