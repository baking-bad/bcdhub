...
func (m *MockGeneralRepository) BulkRemoveField(arg0 string, arg1 []models.Model) error {
	m.ctrl.T.Helper()
...
func (mr *MockGeneralRepositoryMockRecorder) BulkRemoveField(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
