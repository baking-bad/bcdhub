...
// UpdateContracts mocks base method.
func (m *MockTransaction) UpdateContracts(ctx context.Context, updates ...*contract.Update) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx}
	for _, a := range updates {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "UpdateContracts", varargs...)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateContracts indicates an expected call of UpdateContracts.
func (mr *MockTransactionMockRecorder) UpdateContracts(ctx any, updates ...any) *TransactionUpdateContractsCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx}, updates...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateContracts", reflect.TypeOf((*MockTransaction)(nil).UpdateContracts), varargs...)
	return &TransactionUpdateContractsCall{Call: call}
}

// TransactionUpdateContractsCall wrap *gomock.Call
type TransactionUpdateContractsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *TransactionUpdateContractsCall) Return(arg0 error) *TransactionUpdateContractsCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *TransactionUpdateContractsCall) Do(f func(context.Context, ...*contract.Update) error) *TransactionUpdateContractsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *TransactionUpdateContractsCall) DoAndReturn(f func(context.Context, ...*contract.Update) error) *TransactionUpdateContractsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
