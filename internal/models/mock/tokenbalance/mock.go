...
func (m *MockRepository) GetAccountBalances(network, address, contract string, size, offset int64, sort string) ([]tb.TokenBalance, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountBalances", network, address, contract, size, offset, sort)
...
func (mr *MockRepositoryMockRecorder) GetAccountBalances(network, address, contract, size, offset, sort interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountBalances", reflect.TypeOf((*MockRepository)(nil).GetAccountBalances), network, address, contract, size, offset, sort)
}
...
func (m *MockRepository) GetTokenSupply(network, contract string, tokenID int64) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTokenSupply", network, contract, tokenID)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) GetTokenSupply(network, contract, tokenID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTokenSupply", reflect.TypeOf((*MockRepository)(nil).GetTokenSupply), network, contract, tokenID)
}
