...
// Package mock_dapp is a generated GoMock package.
package dapp

import (
	dp "github.com/baking-bad/bcdhub/internal/models/dapp"
...
func (m *MockRepository) Get(slug string) (dp.DApp, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", slug)
	ret0, _ := ret[0].(dp.DApp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) All() ([]dp.DApp, error) {
	m.ctrl.T.Helper()
