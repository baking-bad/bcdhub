...
func (s *Script) getAnnotations() {
	s.Annotations.Append(s.Code.Annotations.Values()...)
	s.Annotations.Append(s.Code.Storage.Annotations.Values()...)
	s.Annotations.Append(s.Code.Parameter.Annotations.Values()...)
}
