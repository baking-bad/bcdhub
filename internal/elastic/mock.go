...
// Source: internal/elastic/interface.go
...
// MockITokenMatadata is a mock of ITokenMatadata interface
type MockITokenMatadata struct {
	ctrl     *gomock.Controller
	recorder *MockITokenMatadataMockRecorder
}

// MockITokenMatadataMockRecorder is the mock recorder for MockITokenMatadata
type MockITokenMatadataMockRecorder struct {
	mock *MockITokenMatadata
}

// NewMockITokenMatadata creates a new mock instance
func NewMockITokenMatadata(ctrl *gomock.Controller) *MockITokenMatadata {
	mock := &MockITokenMatadata{ctrl: ctrl}
	mock.recorder = &MockITokenMatadataMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockITokenMatadata) EXPECT() *MockITokenMatadataMockRecorder {
	return m.recorder
}

// GetTokenMetadata mocks base method
func (m *MockITokenMatadata) GetTokenMetadata(ctx GetTokenMetadataContext) ([]models.TokenMetadata, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTokenMetadata", ctx)
	ret0, _ := ret[0].([]models.TokenMetadata)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTokenMetadata indicates an expected call of GetTokenMetadata
func (mr *MockITokenMatadataMockRecorder) GetTokenMetadata(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTokenMetadata", reflect.TypeOf((*MockITokenMatadata)(nil).GetTokenMetadata), ctx)
}
...
// GetTokenMetadata mocks base method
func (m *MockIElastic) GetTokenMetadata(ctx GetTokenMetadataContext) ([]models.TokenMetadata, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTokenMetadata", ctx)
	ret0, _ := ret[0].([]models.TokenMetadata)
	ret1, _ := ret[1].(error)
