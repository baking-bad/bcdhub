...
func (m *MockINode) GetProtocol() (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockINodeMockRecorder) GetProtocol() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProtocol", reflect.TypeOf((*MockINode)(nil).GetProtocol))
}
